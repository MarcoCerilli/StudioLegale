...
$config['page_slug'] 	= 'water-sports-gear';
...
$config['steps'] = array(
	'intro' => array(
		...
		'title'			=> __( 'Welcome to ', 'water-sports-gear' ) . $theme_title, // Section title
		'icon'			=> 'dashboard', // Uses Dashicons
		'button_text'	=> __( 'Start Now', 'water-sports-gear' ), // Button text
