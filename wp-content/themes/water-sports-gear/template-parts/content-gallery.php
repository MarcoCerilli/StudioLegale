...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="mag-post-single">
        <?php
		    ...
		    $water_sports_gear_post_id = get_the_ID(); // Add this line to get the post ID
		    $water_sports_gear__gallery_shortcode = get_post_gallery();

		    if (!empty($water_sports_gear__gallery_shortcode)) {
		        // Display the gallery
		        echo '<div class="embedded-gallery">' . do_shortcode($water_sports_gear__gallery_shortcode) . '</div>';
		    }
		?>
