(function(api) {
    ...
    api.sectionConstructor['water-sports-gear-upsell'] = api.Section.extend({
    ...
    water_sports_gear_section_lists.forEach(water_sports_gear_homepage_scroll);

    function water_sports_gear_homepage_scroll(item, index) {
        // Detect when the front page sections section is expanded (or closed) so we can adjust the preview accordingly.
        item = item.replace(/-/g, '_');
        wp.customize.section('water_sports_gear_' + item + '_section', function(section) {
