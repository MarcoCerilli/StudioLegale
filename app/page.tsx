...
export default function Home() {
  return (
    <main className="min-h-screen bg-cream text-charcoal selection:bg-rosewood/20">
      {/* 1. HERO SECTION */}
      {/* 1. HERO SECTION - CLEAN & NEUTRAL */}
      <section className="relative h-[85vh] min-h-162.5 flex items-center overflow-hidden bg-black">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/hero-avvocato.jpg"
            alt="Studio Legale Avvocato Anna Fusco Terracina"
            fill
            className="object-cover opacity-80" // Foto più visibile, senza tinte
            priority
            unoptimized
          />
          {/* Overlay sfumato neutro (nero/trasparente) per la leggibilità */}
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12 lg:px-24">
          <div className="max-w-4xl">
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-white/80 text-[10px] tracking-[0.5em] uppercase font-bold">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-12 max-w-xl leading-relaxed font-light">
              Assistenza legale specialistica fondata sul rigore accademico e
              sulla tutela dinamica dei diritti.
            </p>

            <div className="flex flex-col sm:flex-row gap-6">
              {/* Pulsante Principale: Bianco con testo scuro */}
              <Link
                href="/contatti"
                className="flex items-center justify-center gap-3 px-10 py-5 bg-white text-charcoal font-bold transition-all hover:bg-neutral-200 rounded-full group shadow-xl"
              >
              ...
              <Link
                ...
                className="flex items-center justify-center px-10 py-5 border border-white/40 hover:border-white text-white transition-all rounded-full backdrop-blur-md bg-white/5"
              >
                <span className="uppercase tracking-[0.2em] text-[10px]">
                  Aree di Competenza
                </span>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="bg-white p-10 rounded-[2.5rem] border border-rosewood/5 shadow-sm hover:shadow-2xl hover:-translate-y-4 transition-all duration-500 group"
              >
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-white/80 font-light mb-8 leading-relaxed text-sm md:text-base">
                Supporto legale integrato tra diritto civile e penale, con
                particolare attenzione al valore umano.
              </p>
              <Link
                href="/aree-di-attivita"
