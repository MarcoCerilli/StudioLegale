...
const services = [
  {
    ...
    description:
      "Assistenza legale completa per questioni familiari, contratti e successioni con massima sensibilità.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  },
  {
    ...
    slug: "diritto-penale",
    description:
      "Difesa tecnica d'eccellenza in ogni fase del procedimento, garantendo la massima tutela dei diritti.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  },
  {
    ...
    tag: "Verifica Requisiti", // Più professionale di screening
    description:
      "Gestione visti, permessi di soggiorno e cittadinanza italiana con aggiornamento costante sulle normative.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
      ...
      >
        <path
          d="M12 21l-2-2m2 2l2-2m-2 2V12m0 0l-4-4m4 4l4-4M3 7h18"
          strokeLinecap="round"
  ...
  },
  {
    ...
    tag: "Compenso a Risultato", // Toglie ogni dubbio: paghi solo se vinci
    description:
      "Massima determinazione nell'ottenere il giusto ristoro. In ambito infortunistico paghi solo a risultato ottenuto.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Tutela dei diritti dei lavoratori e consulenza aziendale su licenziamenti e contrattualistica.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Rapporti con la Pubblica Amministrazione e gestione dei ricorsi presso i tribunali amministrativi.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
