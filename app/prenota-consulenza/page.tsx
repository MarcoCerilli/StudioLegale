      ...
      <div id="top" className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10 md:mb-16 space-y-4">
          ...
          <p className="text-charcoal/70 max-w-2xl mx-auto text-base md:text-lg font-light leading-relaxed px-2">
            Un colloquio conoscitivo di circa 30 minuti per analizzare i fatti e
            definire insieme la strategia legale migliore.
          </p>
        </div>
          ...
          <div className="space-y-6 md:space-y-8 order-1 lg:order-2">
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-3 md:space-y-4">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex items-center gap-3 text-xs md:text-sm text-cream"
                    >
            ...
            <div className="bg-white p-8 md:p-10 rounded-4xl md:rounded-[3rem] border border-emerald-500/10 shadow-sm">
              <div className="flex items-center gap-3 mb-4 md:mb-6">
                ...
                <h3 className="font-serif text-xl md:text-2xl text-charcoal italic">
                  Contatto Rapido
                </h3>
              </div>
              <p className="text-charcoal/60 mb-6 md:mb-8 font-light text-sm leading-relaxed">
                ...
                WhatsApp può anticipare la documentazione.
              </p>
              <a
